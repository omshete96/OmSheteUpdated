...
const projects = [
  ...
  {
    title: "Legal Document Analyzer (AI-Powered RAG System)",
    description: "Built a RAG-based full-stack application for legal contract analysis, document review, and question answering. Designed a semantic search workflow using ChromaDB and SentenceTransformers to extract and analyze key clauses. Integrated Groq API (Llama 3) for real-time summarization, risk identification, and interactive document chat.",
  ...
  },
  {
    ...
    technologies: ["C++", "Next.js", "Node.js", "Express.js", "Encryption"],
...
const techColors = {
  ...
  "Express.js":"bg-blue-900/40 text-blue-300 border-blue-700/50",
  ...
  AI: "bg-red-900/40 text-red-300 border-red-700/50",
  FastAPI: "bg-teal-900/40 text-teal-300 border-teal-700/50",
  RAG: "bg-indigo-900/40 text-indigo-300 border-indigo-700/50",
  ChromaDB: "bg-orange-900/40 text-orange-300 border-orange-700/50",
  "Groq API": "bg-rose-900/40 text-rose-300 border-rose-700/50",
};
